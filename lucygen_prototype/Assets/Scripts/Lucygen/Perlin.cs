...
public class Perlin {
    ...
    {
        double total = 0;
        double amplitude = 128;         //standard lanscape starting amplitude
        double frequency = 4;           //standard landscape starting frequency
    ...
    public double OctavePerlin(double x, double y, double z, int octaves, double persistence, double initialAmplitude, double initialFrequency)
    {
        double total = 0;
    ...
    public double OctavePerlin(double x, double y, double z, int octaves, double persistence, double initialAmplitude, double initialFrequency, double lacunarity)
    {
        double total = 0;
        double amplitude = initialAmplitude;
        double frequency = initialFrequency;
